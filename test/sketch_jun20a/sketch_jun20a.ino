...
SoftwareSerial espSerial(2,3);   // arduino RX pin=2  arduino TX pin=3    connect the arduino RX pin to esp8266 TX pin   -  connect the arduino TX pin to esp8266 RX pin. 
/*
